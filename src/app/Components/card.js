...
export default function Card({ index, currentIndex, values }) {
  ...
  const className = () => {
    if (positionOffset === 0) {
      return "card-container bg-gray-800 rounded-lg p-4 scrollbar-hiddenuy";
    } else {
      return "card-container bg-gray-800 rounded-lg p-4 scrollbar-hiddenuy blur-[2px]";
    }
  }
